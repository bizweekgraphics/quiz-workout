...
(function () {
    (function () {
        ...
        i = function (e) {
            var t, n;
            t = Math.floor(Math.random() * 1e5);
            n = "" + e.host + "?id=" + e.id + "&pub_date=" + e.pubDate + "&type=" + e.type + "&activity_type=shared&uri=" + e.pingUri + "&randomnumber=" + t;
            return $("body").append('<img src="' + n + '" style="visibility:hidden;" />')
        };
        r = function (e, t, n, r, s) {
            ...
            u = encodeURIComponent(e.headline);
            a = encodeURIComponent(e.summary);
            if (e.tags != null) {
                o = "&hashtags=" + encodeURIComponent(e.tags)
            } else {
                o = ""
            }
            switch (t) {
            case "twitter":
                u = encodeURIComponent("See baseball's worst call of the day, every day, here http://buswk.co/1oSoch5 or follow @umpireauditor");
                // f = "https://twitter.com/intent/tweet?original_referer=" + n + "&text=" + u + "&url=" + r + "&via=BW" + o;
                f = "https://twitter.com/intent/tweet?original_referer=" + n + "&text=" + u;
                break;
            case "facebook":
                f = "https://www.facebook.com/sharer.php?u=" + r + "&t=" + u;
                break;
            case "linked_in":
                f = "http://www.linkedin.com/shareArticle?mini=true&url=" + r + "&title=" + u + "&summary=" + a + "&source=Businessweek.com";
                break;
            case "gplus":
                f = "https://plusone.google.com/_/+1/confirm?hl=en&url=" + r
            }
            if (e.type !== "bloomberg") {
                i(e)
            }
        ...
        n = function (e, t, n, i) {
            var s, o;
            s = window.open("", "Share_Window", "menubar=0,resizable=1,width=550,height=350,toolbar=0,scrollbars=1,location=0");
            o = n.uri;
            if (o == null) {
            ...
            return $.ajax("/shorten", {
                ...
                success: function (e) {
                    var i;
                    i = e.status_code !== 200 ? o : e.data.url;
                    return r(n, t, o, i, s)
                },
                error: function () {
                    return r(n, t, o, o, s)
        ...
        t = function () {
            return $(".share_button").bind("click", function (e) {
                ...
                e.preventDefault();
                t = $(this);
                i = t.data("button-type");
                r = t.parent(".share_buttons").data();
                t.fadeTo(50, .5);
                return n(t, i, r, function () {
                    return t.fadeTo(50, 1)
                })
            })
        };
        e = function (e) {
            return function (t, r, i, s) {
                return $(t).bind("click", function (t) {
                    ...
                    o.fadeTo(50, .5);
                    n(o, e, u, function () {
                        return o.fadeTo(50, 1)
                    });
                    BBBW_comScore.params = {
                        name: "bw.social.sharing",
                        bw_social_type: "social_" + e
                    };
                    BBBW_comScore.track();
                    return BBBW_comScore.write_cookie("comScore", "", -1)
                })
            }
        };
        return this.Platypus.Sharing = {
            init_social_buttons: t,
            init_twitter_button: e("twitter"),
            init_linked_in_button: e("linked_in"),
            init_facebook_button: e("facebook")
        }
    })()
}).call(this);
(function (e, t, n) {
...
(function () {
    ...
    t = function () {
        function e() {}
        e.prototype.load_saved_answers_for = function (e) {
            var t;
            t = n();
            return JSON.parse(t[e] || "{}")
        };
        e.prototype.clear_answers_for = function (e) {
            var t;
            t = n();
            t[e] = "{}";
            return r(t)
        };
        e.prototype.save_answers = function (e, t) {
            var i;
            i = n();
    ...
    r = function (t) {
        return $.cookie(e, JSON.stringify(t))
    };
    this.Platypus.QuizStorage = t
}).call(this);
(function () {
    var e, t, n, r, i;
    r = this.Platypus.QuizStorage;
    t = "question-id";
    e = null;
    n = function () {
        function t(e) {
            var t, n;
            this.quiz_id = e.data("quiz-id");
            if (!this.quiz_id) {
                throw "The quiz markup needs a quiz_id to make a Quiz"
            }
            t = i(e);
            this.answers = t.answers;
            this.correct_answers = t.correct_answers;
            this.quiz_storage = new r;
            n = this.quiz_storage.load_saved_answers_for(this.quiz_id);
            $.extend(this.answers, n)
        }
        t.prototype.answer_question = function (e, t) {
            if (this.question_has_been_answered(e)) {
                return
            }
            this.answers[e] = t;
            return this.quiz_storage.save_answers(this.quiz_id, this.answers)
        };
        t.prototype.question_has_been_answered = function (t) {
            return this.answers[t] !== e
        };
        t.prototype.question_has_not_been_answered = function (e) {
            return !this.question_has_been_answered(e)
        };
        t.prototype.next_unanswered_question = function () {
            var e, t, n;
            n = this.answers;
            for (t in n) {
                e = n[t];
                if (this.question_has_not_been_answered(t)) {
                    return t
                }
            }
            return null
        };
        t.prototype.all_questions_answered = function () {
            var e, t, n;
            n = this.answers;
            for (t in n) {
                e = n[t];
        ...
        t.prototype.answer_for = function (e) {
            return this.answers[e]
        };
        t.prototype.correct_answer_for = function (e) {
            return this.correct_answers[e]
        };
        t.prototype.answer_is_correct = function (e) {
            return this.correct_answers[e] === this.answers[e]
        };
        t.prototype.score = function () {
            var e, t, n, r;
            t = 0;
            r = this.correct_answers;
            for (n in r) {
                e = r[n];
                if (this.answers[n] === e) {
                    t += 1
        ...
        t.prototype.reset = function () {
            return this.quiz_storage.clear_answers_for(this.quiz_id)
        };
        return t
    }();
    i = function (n) {
        ...
        r = {};
        i = {};
        n.find(".quiz_question").each(function (n, s) {
            var o, u, a;
            o = $(s);
            a = o.data(t);
            r[a] = e;
            u = o.find("[data-answer]");
            return i[a] = u.data("option")
        });
        return {
            answers: r,
            correct_answers: i
    ...
    this.Platypus.Quiz = n
}).call(this);
(function () {
    var e, t, n, r, i, s, o, u;
    i = this.Platypus.Quiz;
    r = "question-id";
    o = "/metal/v1/quiz/results.json";
    u = "selected";
    t = "correct";
    n = "incorrect";
    e = {
        bb_c_type: "index",
        bb_cg_1: "specialsections",
        bb_cg_2: "2014yearahead",
        bb_cg_3: "quiz"
    };
    s = function () {
        function s() {}
        s.prototype.quiz = function () {
        ...
        s.prototype.initialize = function () {
            this.init_quiz();
            this.init_next_matte();
            this.init_quiz_routing();
            this.init_sharing();
            return this.init_finale()
        };
        s.prototype.landing_page = function () {
            this.init_sharing();
            this.add_article_track();
            return this.tracking_landing()
        };
        s.prototype.init_quiz = function () {
            var e, t, n;
            t = this;
            e = $(".quiz");
            this.$questions = e.find(".quiz_question");
            this.quiz = n = new i(e);
            return this.$questions.each(function (e, n) {
                var r, i;
                r = $(n);
                i = r.find(".quiz_question_option");
                return i.click(function () {
                    var e, n;
                    e = $(this);
                    n = e.data("option");
                    t.highlight_selection(n);
                    return i.unbind("click")
                })
            })
        };
        s.prototype.init_quiz_routing = function () {
            var e;
            e = this.get_requested_question_id();
            if (e) {
                this.show_question(e)
            } else {
                this.show_next_question()
            }
            return $(window).hashchange($.proxy(this.show_requested_question, this))
        };
        s.prototype.init_finale = function () {
            var e;
            e = this;
            return $("a.again").click(function (t) {
                t.preventDefault();
                e.reset_quiz();
                e.init_quiz();
                return e.back_to_beginning()
            })
        };
        s.prototype.back_to_beginning = function () {
            return window.location.reload()
        };
        s.prototype.get_requested_question_id = function () {
            var e;
        ...
        s.prototype.show_requested_question = function () {
            var e;
            e = this.get_requested_question_id();
            if (e) {
                return this.show_question(e)
            }
        };
        s.prototype.$current_question = function () {
            return this.$questions.filter("[data-question-id=" + this.current_question_id + "]")
        };
        s.prototype.init_next_matte = function () {
            this.$next_matte = $(".matte");
            this.$next_matte.detach().show();
            return this.$next_matte.click($.proxy(this.show_next_question, this))
        };
        s.prototype.display_next_matte = function (e) {
            var t, n;
            if (e == null) {
                e = false
            }
            t = this.$current_question().find(".content");
            n = this.$next_matte;
            if (e) {
                return n.appendTo(t)
            } else {
        ...
        s.prototype.hide_next_matte = function () {
            return this.$next_matte.detach()
        };
        s.prototype.highlight_selection = function (e, i) {
            var s, o, a, f, l;
            if (i == null) {
                i = false
            }
            a = this.$questions.find(".quiz_question_option[data-option=" + e + "]");
            o = a.closest(".quiz_question");
            s = o.find(".quiz_question_option");
            l = o.data(r);
            e = a.data("option");
            this.quiz.answer_question(l, e);
            s.removeClass(u);
            a.addClass(u);
            f = this.quiz.answer_is_correct(l) ? t : n;
            o.addClass(f);
            return this.display_next_matte(i)
        };
        s.prototype.show_question = function (e) {
            this.current_question_id = e;
            this.hide_next_matte();
            this.$questions.hide();
            this.$questions.filter("[data-question-id=" + e + "]").show();
            if (this.quiz.question_has_been_answered(e)) {
                this.highlight_selection(this.quiz.answer_for(e), true)
            }
            return this.tracking(e)
        };
        s.prototype.show_next_question = function () {
            var e;
            e = this.quiz.next_unanswered_question();
            if (e) {
                this.route_to_question(e)
            } else {
                this.show_end_results_slide();
                this.clear_hash()
            }
            return BLOOMBERG.ads.refresh({
                data: {
                    frame_number: 0
                }
            })
        };
        s.prototype.show_end_results_slide = function () {
            this.$questions.hide();
            $(".end_results_slide").show();
            if (this.published_quiz()) {
                this.record_quiz_result();
                return this.tracking("results_slide")
            }
        };
        s.prototype.published_quiz = function () {
            if ($("body").data("action") === "quiz") {
                return true
            } else {
                return false
            }
        };
        s.prototype.init_sharing = function () {
            var e;
            e = $(".social_buttons");
            return this.init_sharing_for(e)
        };
        s.prototype.init_sharing_for = function (e) {
            return e.each(function (e, t) {
                ...
                r = n.data("message");
                i = n.data("tags");
                Platypus.Sharing.init_twitter_button(n.find(".twitter"), s, r, i);
                Platypus.Sharing.init_facebook_button(n.find(".facebook"), s, r, i);
                return Platypus.Sharing.init_linked_in_button(n.find(".linked_in"), s, r)
            })
        };
        s.prototype.route_to_question = function (e) {
            return window.location.hash = "#" + e
        };
        s.prototype.display_score = function (e, t, n) {
            var r, i, s, o, u;
            $("p.score_message").html(t.score_message);
            $("p.percentile_message").html(t.percentile_message);
            s = $(".quiz_question").length;
            o = $("h1").text();
            u = "I scored " + e.quiz.results().score + "/" + s + " on @BW's " + o + " quiz. Can you beat me?";
            r = $(".end_results_slide");
            i = r.find(".share .end_social_buttons");
            i.attr("data-message", u);
            r.find(".message").html(u);
            if (typeof n === "function") {
                return n()
            }
        };
        s.prototype.clear_hash = function () {
            return window.location.hash = ""
        };
        s.prototype.reset_quiz = function () {
            return this.quiz.reset()
        };
        s.prototype.record_quiz_result = function () {
            var e;
            e = this;
            return $.post(o, this.quiz.results()).done(function (t) {
                return e.display_score(e, t, function () {
                    var t;
                    t = $(".end_results_slide .end_social_buttons");
                    return e.init_sharing_for(t)
                })
            })
        };
        s.prototype.add_article_track = function () {
            return $(".section").each(function () {
                var e, t, n;
                t = $(this);
                e = t.find(".articles_list a");
                n = this.className.match(/\w*/);
                e.addClass("tracked quiz_tracked");
                e.attr("title", n);
                e.attr({
                    "data-category": "quiz",
                    "data-action": "click",
                    "data-action-type": n + " article"
                });
                return t.bindEventTracking(this.className, true)
            })
        };
        s.prototype.tracking = function (e) {
            var t;
            t = "bw.specialsections:2014yearahead:quiz" + $(".quiz").data("quiz-id") + ":" + e;
            this.comscore_tracking(e, t);
            return BLOOMBERG.track_event("Quiz", "Quiz-" + $(".quiz").data("quiz-id"), e)
        };
        s.prototype.comscore_tracking = function (t, n) {
            BBBW_comScore.params = e;
            BBBW_comScore.params["name"] = n;
            BBBW_comScore.params["ns_type"] = "hidden";
            BBBW_comScore.track();
            return BBBW_comScore.write_cookie(comScore_track_key, "", -1)
        };
        s.prototype.tracking_landing = function () {
            var e;
            e = this;
            return $(".quiz_tracked").click(function () {
                var t, n;
                n = $(this).text();
                t = "bw.specialsections:2014yearahead:quiz" + ":" + n;
                return e.comscore_tracking(n, t)
            })
        };
        return s
    }();
    ...
    s.INCORRECT_CLASS = n;
    (function () {
        this.Platypus.quizzes = new s;
        return this.Platypus.QuizzesController = s
    })()
}).call(this);
(function () {
    if (typeof BLOOMBERG === "undefined" || BLOOMBERG === null) {
        window.BLOOMBERG = {};
        BLOOMBERG.namespace = function (e) {
            var t, n, r, i, s;
            t = e.split(".");
            n = window.BLOOMBERG;
            if (t[0] === "BLOOMBERG") {
...
(function () {
    var e = BLOOMBERG.namespace("ads"),
        t = {},
        n = {};
    e.is_blank = function (e) {
        var t = false;
        var n = "bw-no-show-ad";
        var r = "817-grey";
        if ($.browser.msie) {
            var i = e.document.getElementById("ad_div_container").innerHTML;
            if (i.indexOf(n) >= 0 || i.indexOf(r) >= 0) {
                t = true
            }
        } else {
            var s = $(e).find('img[src*="' + n + '"]').size();
            var o = $(e).find('img[src*="' + r + '"]').size();
            if (s > 0 || o > 0) {
                t = true
            }
        }
    ...
    e.is_rich_media = function (e) {
        return $(e).siblings().size() > 0
    };
    e.resize_top_companion = function () {
        if (!e.is_blank($("#top_companion_ad"))) {
            var t = $("#top_companion_ad").outerHeight();
            $("#top_companion_ad").css("height", t);
            $("#top_companion_ad").parent().css("height", t).addClass("non_blank_ad")
        }
    };
    e.resize_iframe = function (t) {
        function r(e) {
            var t = 0;
            if (e.contentWindow.document.getElementById("ad_div_container") != null) {
                t = e.contentWindow.document.getElementById("ad_div_container").offsetHeight
            }
            return t
        }
        ...
        var n = t;
        if (n.contentWindow.document.getElementById("ad_div_container") == null) {
            return false
        }
        var i = setInterval(function () {
            if (!e.is_blank(n.contentWindow) && !e.is_rich_media(n)) {
                if (r(n) > 1) {
                    $(n).css("height", r(n));
                    $(n).parent().css("height", r(n)).addClass("non_blank_ad");
                    n.contentWindow.document.getElementById("ad_div_container").style.display = "block"
                }
            } else if (e.is_rich_media(n)) {
                $(n).hide();
                $(n).parent().addClass("non_blank_ad").append('<div style="clear:both"></div>');
                s(i)
            } else {
                s(i)
            }
    ...
    e.refresh = function (e) {
        var t = e.data.frame_number == "" || e.data.frame_number == undefined || e.data.frame_number == null ? 0 : e.data.frame_number;
        var n = $("iframe.ad_frame").size();
        var r = $("iframe.ad_frame").eq(t);
        var i = $(r);
        $(r).attr("src", "");
        var s = {
            tile: $(i).attr("data-tile"),
            size: $(i).attr("data-size"),
            tz: $(i).attr("data-tz"),
            pt: $(i).attr("data-pt")
        };
        var o = $(r).attr("data-uri") + "?" + $.param(s);
        $(r).attr("src", o);
        t = t + 1;
        $(r).unbind("load");
        if (t <= n) {
            $(r).load(function () {
                var e = this;
                BLOOMBERG.ads.refresh({
                    data: {
                        frame_number: t
                    }
                });
                BLOOMBERG.ads.resize_iframe(e)
            })
        }
    };
    e.tag_user = function () {
        if (BLOOMBERG.bw_core.is_department_page() && AD_KEYWORD) {
            var e = "department=" + AD_KEYWORD;
            BLOOMBERG.local_storage.set("user", e)
        }
    };
    e.target_by = {
        department: function (e) {
            if ($('meta[name="keywords"]').size() <= 0) return false;
            var t = $('meta[name="keywords"]').attr("content").split(",");
            if (jQuery.inArray(e, t) >= 0) {
                AD_KEYWORD = "tagged_as_" + e
            }
        }
    };
    e.target_user = function () {
        var t = BLOOMBERG.local_storage.get("user");
        if (t == null || !BLOOMBERG.bw_core.is_content_page()) return false;
        var n = {};
        t.replace(new RegExp("([^?=&]+)(=([^&]*))?", "g"), function (e, t, r, i) {
            n[t] = i
        });
        if (n["department"]) e.target_by.department(n["department"]);
        BLOOMBERG.local_storage.remove("user")
    };
    e.inject_chartbeat = function () {
        $(".advertisement").each(function () {
            var e = $(this).children("iframe").attr("data-position");
            if (e !== undefined && e !== null) {
                $(this).attr("data-cb-ad-id", e)
            }
        });
        if (typeof AD_LAYOUT_DESC != "undefined") {
            if ((new RegExp("videos")).test(AD_LAYOUT_DESC)) {
                $(".top_banner_ad").each(function () {
                    $(this).attr("data-cb-ad-id", "top")
                })
            } else {
                $(".banner_ad").attr("data-cb-ad-id", "top")
            }
        }
    };
    $(document).ready(function () {
        ...
        $(".trigger_refresh").live("click", {
            frame_number: 0
        }, BLOOMBERG.ads.refresh);
        if (typeof AD_DEPT_TRACKING != "undefined" && AD_DEPT_TRACKING) {
            e.tag_user();
            e.target_user()
        }
        e.inject_chartbeat()
...
(function () {
    $(function () {
        return $(".tracked").each(function () {
            var e, t, n, r, i, s, o, u, a, f, l, c;
            s = String($(this).attr("data-actions") || "click");
            t = $(this).attr("data-action-type");
            n = $(this).attr("data-category");
            o = $(this).attr("data-label");
            u = $(this).attr("data-value");
            r = $(this).attr("data-delegate");
            l = s.split(" ");
            c = [];
            for (a = 0, f = l.length; a < f; a++) {
                ...
                e = t != null ? "" + t + " (" + i + ")" : i;
                if (r != null) {
                    c.push($(this).delegate(r, i, {
                        category: n,
                        action: e,
                        label: o,
                        value: u
                    }, function (e) {
                        return BLOOMBERG.track_event(e.data.category, e.data.action, e.data.label, e.data.value)
                    }))
                } else {
                    c.push($(this).bind(i, {
                        category: n,
    ...
    BLOOMBERG.track_event = function (e, t, n, r) {
        if (r == null) {
            r = 1
        }
        if (typeof _gaq !== "undefined" && _gaq !== null) {
            return _gaq.push(["_trackEvent", e, t, n, r])
        }
    }
}).call(this);
...
var comScore_track_key = "comScore";
var BBBW_comScore = new function () {
    ...
    this.get_uid_value = function () {
        var e = new Date;
        return this.site_id + "." + this.rand(10) + "." + e.getTime()
    };
    this.set_uid_cookie = function () {
        this.read_cookie(this.unique_cookie) ? "" : this.write_cookie(this.unique_cookie, this.get_uid_value(), 36159)
    };
    this.write_cookie = function (e, t, n) {
        if (n) {
            var r = new Date;
    ...
    this.tracking_url = function () {
        var e = this.params,
            t = "",
            n = this.read_cookie(this.unique_cookie),
            r = typeof encodeURIComponent != "undefined" ? encodeURIComponent : escape;
        t = t + "http" + (document.location.href.charAt(4) == "s" ? "s://sb" : "://b") + ".scorecardresearch.com/p?c1=2&c2=" + r(this.account_id);
        t = t + "&" + r(this.prefix) + "_vid=" + n;
        for (var i in e) {
            t = t + "&" + r(i) + "=" + r(e[i])
        }
        return t
    ...
    this.track = function () {
        function t(e) {
            var t = "comScore",
                ...
                s = "undefined",
                o = 2048,
                u, a, f, l, c = "characterSet",
                h = "defaultCharset",
                p = typeof encodeURIComponent != s ? encodeURIComponent : escape;
            if (n.cookie.indexOf(t + "=") != -1) {
                f = n.cookie.split(";");
                for (l = 0, r = f.length; l < r; l++) {
                    var d = f[l].indexOf(t + "=");
                    if (d != -1) {
                        i = "&" + unescape(f[l].substring(d + t.length + 1))
                    }
                }
            }
            e = e + "&ns__t=" + (new Date).getTime();
            e = e + "&ns_c=" + (n[c] ? n[c] : n[h] ? n[h] : "") + "&c8=" + p(n.title) + i + "&c7=" + p(r && r.href ? r.href : n.URL) + "&c9=" + p(n.referrer);
            if (e.length > o && e.indexOf("&") > 0) {
                u = e.substr(0, o - 8).lastIndexOf("&");
                e = (e.substring(0, u) + "&ns_cut=" + p(e.substring(u + 1))).substr(0, o)
            }
            if (n.images) {
                a = new Image;
                if (typeof ns_p == s) {
                ...
                n.write(["<", "p", "><", 'img src="', e, '" height="1" width="1" alt="*"', "><", "/p", ">"].join(""))
            }
        }
        this.set_uid_cookie();
        var e = this.tracking_url();
        t(e);
    }
};
(function () {
    var e = BLOOMBERG.namespace("event_track"),
        t = {},
        n = {};
    e.init = function () {};
    e.linkTrack = function () {
        $(".tracked").each(function () {
            var e = $(this).attr("class");
            $(this).bindEventTracking(e, true)
        })
    };
    e.google = function (e, t, n, r) {
        try {
            _gaq.push(["_trackEvent", e, t, n, r])
        } catch (i) {}
        return true
    };
    e.comscore = function (e, t, n) {
        var r = "bb_linkname=" + e + "&bb_linkpos=" + t + "&bb_linktype=" + n;
        BBBW_comScore.write_cookie(comScore_track_key, r)
    };
    e.escape_tracking_value = function (e) {
        return encodeURIComponent($.trim(e).replace("=", "").replace("&", ""))
    };
...
$.fn.bindEventTracking = function (e, t) {
    var n = $(this).find("a:visible");
    if (typeof t != "undefined" && t) {
        n = $(this).find("a")
    }
    return n.each(function (t, n) {
        $(this).mousedown(function () {
            var n = BLOOMBERG.event_track.padNumber(t, 2);
            link_name = "module_link_tracking";
            link_position = BLOOMBERG.event_track.escape_tracking_value(e.replace("tracked", "")) + n;
            link_type = "text";
            BLOOMBERG.event_track.comscore(link_name, link_position, link_type);
            BLOOMBERG.event_track.google(link_name, link_position, link_type, 1)
        })
    })
};
(function (e, t) {
    ...
    e(function () {
        var n = e("body");
        var r = [n.data("controller")].toString().replace(/\//g, "_");
        var i = n.data("action");
        var s = Platypus[r];
        if (s !== t) {
            if (e.isFunction(s.init)) {
                s.init()
            }
            if (e.isFunction(s[i])) {
                s[i]()
